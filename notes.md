...
Rather than going over the morality of it, here are some of the big changes we will see over the next two decades.
...
In effect we will give some one who is not blessed with the genetics that they may want with genetics that is borrowed from some where else.
We will become the designer in our design.
In this way we will break evolution and biology at a fundamental level.
We will see a cambrian explosion of successors to homo-sapien.
